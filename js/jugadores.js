...
fetch(
  ...
  .then((data) => {
    jugadores = data.map(
      (jugador) => `<div class="col-12 col-md-4 p-3 float-start">
     <div class="card">
       <div class="img-wrapper"><img src="https://julioavantt.github.io/guayerd-project-images/img/${jugador.dorsal}.jpg" class="card-img-top" alt="${jugador.name}"></div>
       <div class="card-body">
...
jugadores = jugadores.map(
  (jugador) => `<div class="col-12 col-md-6 col-lg-4 col-xl-3 p-2 float-start">
 <div class="card">
   <div class="img-wrapper"><span>${jugador.dorsal}</span><img src="https://julioavantt.github.io/guayerd-project-images/img/${jugador.dorsal}.jpg" class="card-img-top" alt="${jugador.name}"></div>
   <div class="card-body">
     <h5 class="card-title">${jugador.name}</h5>
     <p class="card-text">Edad: ${jugador.edad}</p>
     <p class="card-text">Posición: ${jugador.posicion}</p>
